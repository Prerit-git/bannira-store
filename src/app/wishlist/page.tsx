...
import { ShoppingBag, Trash2, CheckCircle2, ArrowRight, X, ChevronLeft, Plus } from "lucide-react";
...
export default function WishlistPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFCFB] pt-28 md:pt-40 pb-10 relative selection:bg-stone-200">
      <div className="max-w-[1440px] mx-auto px-5 md:px-10">
        ...
        <header className="mb-10 flex flex-col gap-6">
          ...
          <div className="flex items-baseline gap-3">
            <h1 className="text-3xl md:text-5xl font-serif text-[#1C1C1C]">Your Wishlist</h1>
        ...
        {wishlist.length > 0 ? (
          <>
            ...
            >
              <p className="text-[11px] font-bold text-stone-400 uppercase tracking-[0.3em] mb-6">Want to see more?</p>
              <Link 
                href="/products" 
              ...
              >
                Continue Shopping <Plus size={16} className="group-hover:rotate-90 transition-transform duration-500" />
              </Link>
            </motion.div>
          </>
        ) : (
          ...
          <div className="h-[50vh] flex flex-col items-center justify-center text-center max-w-sm mx-auto">
            <ShoppingBag size={40} strokeWidth={1} className="text-stone-200 mb-8" />
            <h2 className="text-2xl font-serif mb-4 italic text-stone-800">Your list is waiting</h2>
            <Link 
              href="/products" 
            ...
            <div className="w-full max-w-[420px] bg-[#1C1C1C] text-white rounded-[2rem] shadow-[0_30px_60px_rgba(0,0,0,0.4)] border border-white/10 p-3 flex items-center justify-between gap-2 backdrop-blur-2xl pointer-events-auto">
              ...
              <div className="flex items-center gap-3 pl-2">
                ...
                <div className="flex flex-col font-poppins min-w-0">
                  <span className="text-[10px] font-black uppercase tracking-widest text-[#D4AF37] truncate">Moved to Bag</span>
                  <span className="text-[9px] text-stone-400 truncate">Ready for checkout</span>
                </div>
              </div>
